...
--
-- This migration renames the `colonial_*` place columns to their
-- `historical_*` equivalents. The place authority covers
-- administrative divisions across several centuries of Colombian and
-- wider neogranadino history, not only the colonial period;
-- "Colonial gobernacion" is misleading shorthand when the same
-- columns also hold Republican and pre-Hispanic administrative
